...
public class DialogueUtility : MonoBehaviour
{
    ...
    private const string ANIM_START_REGEX_STRING = @"\[(?<anim>shake|wave)\]";
    private static readonly Regex animStartRegex = new Regex(ANIM_START_REGEX_STRING);
    private const string ANIM_END_REGEX_STRING = @"\[/\]";
    ...
    public static string RemoveAnimationTags(string input)
    {
